...
public class EmprestimoController {
	...
	public ResponseEntity<List<Emprestimo>> listarEmprestimos(){
		return new 
				ResponseEntity<> (emprestimoService.listarEmprestimos(), HttpStatus.OK);
		
	}
	@GetMapping ("{id}")
	public ResponseEntity<Emprestimo> buscarPorId(@PathVariable Integer id){
		return new 
				ResponseEntity<> (emprestimoService.buscarEmprestimoPorId(id), 
						HttpStatus.OK);
	}
	...
	public ResponseEntity<Emprestimo> salvar (@RequestBody Emprestimo emprestimo) {
		return new 
				ResponseEntity<> (emprestimoService.salvarEmprestimo(emprestimo), 
						HttpStatus.CREATED);
	}
	@PutMapping
	public ResponseEntity<Emprestimo> atualizar(@RequestBody Emprestimo emprestimo) {
		return new
				ResponseEntity<> (emprestimoService.atualizarEmprestimo(emprestimo), 
						HttpStatus.CREATED);
	}
